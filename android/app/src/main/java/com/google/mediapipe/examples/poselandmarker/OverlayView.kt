...
class OverlayView(context: Context?, attrs: AttributeSet?) :
    ...
    override fun draw(canvas: Canvas) {
        super.draw(canvas)
        // Iterate over the detected poses to draw to the canvas
        results?.let { poseLandmarkerResult ->
            for(landmark in poseLandmarkerResult.landmarks()) {
                ...
                // Skeletal lines via PoseLandmarker.POSE_LANDMARKS (a list containing the skeletal line
                // definitions for human poses, defining which key points need to be connected to form a line)
